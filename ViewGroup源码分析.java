...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        * */
        ...
        if (onFilterTouchEventForSecurity(ev)) {
                ...
                if (actionMasked == MotionEvent.ACTION_DOWN
                    ...
                    if (newTouchTarget == null && childrenCount != 0) {
                        ...
                        for (int i = childrenCount - 1; i >= 0; i--) {
                            ...
                            //  newTouchTarget=null;  move   newTouchTarget!=null
                            /**
                             * 优化   之一      如果
                             */
            ...
            //如果  intercept  =  true   mFirstTouchTarget==null

            // Dispatch to touch targets.
            //   mFirstTouchTarget  ！=null
            if (mFirstTouchTarget == null) {
                // No touch targets so treat this as an ordinary view.
                //dispatchTransformedTouchEvent  第三个参数   非常重要    null
    ...
    private void cancelAndClearTouchTargets(MotionEvent event) {
        //如果第一次触发Down    mFirstTouchTarget==null
        //
        if (mFirstTouchTarget != null) {
    ...
    private boolean dispatchTransformedTouchEvent(MotionEvent event, boolean cancel,
        ...
        //cancel==false  直接调用了   父类  VIew   super.dispatchTouchEvent(event);
